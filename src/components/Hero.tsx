      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative h-[600px] lg:h-[700px] w-full flex items-center justify-center">
          ...
          <motion.div 
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 w-[85%] sm:w-[70%] h-[90%] bg-gradient-to-br from-[#FF6B4A] to-[#E8502A] rounded-[4rem] md:rounded-[6rem] shadow-2xl overflow-hidden"
          >
          ...
          >
             <div className="relative w-full h-full max-w-[600px] mx-auto flex items-center justify-center">
                 <Image 
                    ...
                    fill
                    className="object-contain object-right drop-shadow-2xl scale-110 -ml-10 mt-10"
                    priority
                 />
          ...
          >
             ...
             <div className="bg-white px-4 py-2 rounded-2xl rounded-tl-sm shadow-md flex items-center gap-2 text-sm font-medium ml-4 animate-float" style={{ animationDelay: '1s' }}>
                 <div className="w-5 h-5 bg-[#4A90E2] rounded-full flex items-center justify-center text-white text-[10px]"><Check className="w-3 h-3" /></div>
          ...
          >
            ...
            <p className="text-sm font-sans text-brand-dark/80 leading-tight mt-1">More orders this weekend</p>
          </motion.div>
